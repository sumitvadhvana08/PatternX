...
for(int i=0;i&lt;(2*x-1);i++){<br>
    ...
    for(int j=0;j&lt;pos;j++){<br>
        System.out.print(" ");<br>
    }<br>

    System.out.print((char)(65+pos));<br>

    int space=(2*(x-pos)-3);<br>

    if(space&gt;=1){<br>

        for(int j=1;j&lt;=space;j++){<br>
            System.out.print(" ");<br>
        }<br>
...
function p5(){
    ...
    for(let i=0;i<(2*x-1);i++){
        ...
        str+=String.fromCharCode(65+pos);
