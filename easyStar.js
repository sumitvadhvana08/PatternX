...
document.querySelector(".A5").innerHTML = output;
    }
...
document.querySelector(".A7").innerHTML = output;
    }
}
function c7(){
    document.querySelector('.A7').innerHTML=
...
function p8(){
    ...
    if(x>15){
        ...
        document.querySelector(".A8").innerHTML = output;
    }
}
function c8(){
    document.querySelector('.A8').innerHTML=
...
document.querySelector(".A9").innerHTML = output;
    }
}
function c9(){
    document.querySelector('.A9').innerHTML=
